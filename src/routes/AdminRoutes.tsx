...
import { RequireAuthRoute } from "../shared/components";
...
export const AdminRoutes = () => (
  <Routes>
    <Route element={<RequireAuthRoute accessRole="admin" />}>
      ...
      <Route path="events/organizers/new" element={<CreateOrganizersPage />} />
      <Route path="events/organizers/:id" element={<CreateOrganizersPage />} />
      <Route path="events/categories" element={<CategoriesListPage />} />
      <Route path="events/categories/new" element={<CreateCategoriesPage />} />
      <Route path="events/categories/:id" element={<CreateCategoriesPage />} />
      ...
      <Route path="forms/user-templates/new" element={<FormsUserListPage />} />
      <Route path="forms/user-templates/:id" element={<FormsUserListPage />} />

      <Route path="forms/categories" element={<FormsCategoriesListPage />} />
      <Route path="forms/categories/new" element={<CreateFormsCategories />} />
      <Route path="forms/categories/:id" element={<CreateFormsCategories />} />
      {/* <Route
