...
const DefaultHome: React.FC = () => {
  return (
    <>
      <div className="w-full hidden md:block h-screen absolute top-0  left-0">
        <img
      ...
      <div className="w-full  md:bg-gray-200 md:flex md:flex-col md:justify-between md:h-5/6 md:top-1/2 md:-translate-y-1/2 md:left-1/2 md:-translate-x-1/2 md:rounded-2xl md:w-[624px] md:p-8 md:mx-auto h-full absolute top-0 z-20 m-0 md:pb-5">
        <img
