    ...
    return (
        <div className="flex flex-col max-w-5xl gap-x-5 md:flex-row">
            <div className="flex-1">
                        ...
                        bodyData={
                            questionnaire?.questions?.map((question) => (
                                <Table.Row key={question?.id}>
                                    ...
                                    <Table.Data>{question?.averageRating?.toFixed(2)}</Table.Data>
                                </Table.Row>
                            )) || []
                        }
                    />
                ...
                <Panel title="Kommentare" className="max-w-[50.6rem] mt-5" submitButton={false}>
                    <Panel.Body>
                        {questionnaire?.assignments?.map((assignment) => (
                            <div key={assignment?.id} className="p-2 my-2 border border-gray-400">
